                ...
                <div className="bg-[#3BBCA0] text-white py-2 px-4 sm:px-8 flex flex-col sm:flex-row justify-between items-center text-sm font-medium relative">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button
                            ...
                            className="bg-[#2A9D84] hover:bg-[#238b73] text-white px-6 py-1.5 rounded uppercase text-xs font-bold tracking-wider transition-colors border border-white/20 shadow-sm cursor-pointer"
                        >
